...
import com.example.pjtrestaurant.naver.NaverClient;
...
import com.example.pjtrestaurant.wishList.repository.WishListRepository;
...
public class WishListService {
    ...
    public WishListDto search(String query){
        ...
        if (searchLocalRes.getTotal() > 0){
            ...
            // 이미지 검색
            var imageQuery = localItem.getTitle().replaceAll("<[^>]*>", ""); // 이상한 문자 없애기
